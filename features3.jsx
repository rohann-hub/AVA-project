            ...
            <React.Fragment key={f.index}>
              ...
              >
                <div
                  ...
                  style={{ borderRadius: CARD_RADIUS, boxShadow: cardGlow(f.tone) }}
                >
                  <div
                    className="w-full h-full flex flex-col items-center justify-center p-6 text-white relative"
                    style={{ borderRadius: CARD_RADIUS_INNER, background: cardBackground(f.tone) }}
                  >
